  ...
  if (data.length === 0) {
    return (
      <div className="text-center py-16 bg-white rounded-xl border border-slate-200 shadow-sm">
        <h3 className="text-lg font-semibold text-slate-900 mb-1">Belum ada riwayat absensi</h3>
        <p className="text-slate-500">Riwayat kehadiran kegiatan ekstrakurikuler akan muncul di sini.</p>
      </div>
    );
  }
